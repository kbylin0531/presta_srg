<?php /* Smarty version Smarty-3.1.19, created on 2016-10-30 10:04:12
         compiled from "/home/asus/workspace/sharin7/Public/themes/default-bootstrap/history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10085208805815c59c52a3f5-39403567%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7b0a87b4f00a0ceab07c0010f4cccf3eb793c38b' => 
    array (
      0 => '/home/asus/workspace/sharin7/Public/themes/default-bootstrap/history.tpl',
      1 => 1476936586,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10085208805815c59c52a3f5-39403567',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5815c59c5f8ff7_55541785',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5815c59c5f8ff7_55541785')) {function content_5815c59c5f8ff7_55541785($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/home/asus/workspace/sharin7/Public/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<?php $_tmp50=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-detail',true,null,"id_order=".$_tmp50), ENT_QUOTES, 'UTF-8', true);?>
');">
...
, '<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
<?php $_tmp51=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-detail',true,null,"id_order=".$_tmp51), ENT_QUOTES, 'UTF-8', true);?>
');">
								<span>
...
<?php $_tmp52=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc',true,null,"submitReorder&id_order=".$_tmp52), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php } else { ?>
								<a class="link-button" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
<?php $_tmp53=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"submitReorder&id_order=".$_tmp53), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php }?>

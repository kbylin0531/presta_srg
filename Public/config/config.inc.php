...
*/
use Application\System\Utils\PsKits;
$currentDir = dirname(__FILE__);

require $currentDir.'/../../Sharin/web.inc';
require SR_PATH_BASE.'Application/System/Utils/PsKits.php';

/* Custom defines made by users */
PsKits::loadConfig('defines_custom.inc.php');
PsKits::loadConfig('defines.inc.php');
...
PsKits::loadConfig('settings.inc.php');
PsKits::loadConfig('autoload.php');
PsKits::loadConfig('bootstrap.php');

/* Custom config made by users */
PsKits::loadConfig('settings_custom.inc.php');
...
/* Redefine REQUEST_URI and HTTP_HOST if empty (on some webservers...) */

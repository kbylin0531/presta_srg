                ...
                if (isset($name) && $module = Module::getInstanceByName($name)) {
                    ...
                    if ($install) {
                        if (!Module::isInstalled($name)) {
                            if (!$module->install()) {
                                $this->_errors[] = 'install'.Tools::displayError('An error occurred while installing the module:').$name;
                            }
                        }
                    } elseif (Module::isInstalled($name)) {
                        if (!$module->uninstall()) {
                            $this->_errors[] = 'uninstall'.Tools::displayError('An error occurred while uninstalling the module:').$name;
                        }
                    }
